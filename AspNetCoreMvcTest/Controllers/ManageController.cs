namespace AspNetMvcCoreIdentityTemplate.Controllers
{
    using System;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var model = new ManageIndexViewModel
            {
                ...
                IsEmailConfirmed = false, //user.EmailConfirmed,
        ...
        public async Task<IActionResult> Index(ManageIndexViewModel model)
        {
            ...
            var phoneNumber = string.Empty; // user.PhoneNumber;
        ...
        public async Task<IActionResult> LinkLoginCallback()
        {
            ...
            var info = await _signInManager.GetExternalLoginInfoAsync($"{user.UserId}");
            if (info == null)
            {
        ...
        public async Task<IActionResult> EnableAuthenticator(EnableAuthenticatorViewModel model)
        {
            ...
            _logger.LogInformation($"User with ID {user.UserId} has enabled 2FA with an authenticator app.");
        ...
        public async Task<IActionResult> ResetAuthenticator()
        {
            ...
            _logger.LogInformation($"User with id '{user.UserId}' has reset their authentication app key.");
        ...
        public async Task<IActionResult> GenerateRecoveryCodes()
        {
            ...
            var recoveryCodes = await _userManager.GenerateNewTwoFactorRecoveryCodesAsync(user, 10);
            _logger.LogInformation($"User with ID {user.UserId} has generated new 2FA recovery codes.");
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("AspNetMvcCoreIdentityTemplate"),
