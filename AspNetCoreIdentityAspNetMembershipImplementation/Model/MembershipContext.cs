        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AspnetApplications>(entity =>
            {
                ...
                entity.HasIndex(e => e.ApplicationName)
                    .HasName("UQ__aspnet_A__30910331297722B6")
                    .IsUnique();
            ...
            modelBuilder.Entity<AspnetMembership>(entity =>
            {
                ...
                entity.Property(e => e.PasswordQuestion).HasMaxLength(512);
            ...
            modelBuilder.Entity<AspnetUsers>(entity =>
            {
                ...
                entity.Property(e => e.MobileAlias).HasMaxLength(32);
            ...
            modelBuilder.Entity<AspnetWebEventEvents>(entity =>
            {
                ...
                entity.Property(e => e.ApplicationPath).HasMaxLength(512);

                entity.Property(e => e.ApplicationVirtualPath).HasMaxLength(512);
                ...
                entity.Property(e => e.MachineName).HasMaxLength(512);
